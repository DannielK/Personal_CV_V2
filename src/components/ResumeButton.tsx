...
const FullResumeButton = () => {
  return (
    ...
    //   <FontAwesomeIcon
    //     icon={faArrowRight}
    //     className="ml-2 inline-block size-3 shrink-0 -rotate-45 transition-transform group-hover:-translate-y-1 group-hover:translate-x-1 motion-reduce:transition-none"
    //   />
    // </a>
    <a
      href="/Danniel_Kim_Resume.pdf"
